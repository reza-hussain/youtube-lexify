  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      <div className="max-w-5xl mx-auto px-6 py-16">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors mb-12"
        >
          <ArrowLeft size={16} />
          Back to Dashboard
        </Link>
              ...
              <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-5 py-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-amber-800">
                    Subscription ending {renewalDate}
                  </p>
                  <p className="text-xs text-amber-600 mt-0.5">
                    You still have full Pro access until then.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  ...
                  <p
                    className={`text-sm font-bold ${sub?.cancelAtPeriodEnd ? 'text-amber-600' : 'text-green-600'}`}
                  >
                    {sub?.cancelAtPeriodEnd ? 'Cancelled' : 'Active'}
                  </p>
                </div>
              </div>
            </div>
            ...
            {sub && !sub.cancelAtPeriodEnd && (
              <div className="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm">
                ...
                <p className="text-xs text-slate-500 mb-4">
                  You'll keep Pro access until {renewalDate}. No refunds are issued for partial
                  periods.
                </p>
                {!confirmCancel ? (
                  <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-cyan-500 rounded-[28px] p-8 shadow-xl shadow-blue-500/20 flex flex-col overflow-hidden">
                ...
                <div className="relative mb-6">
                  ...
                  {PLANS[billing].total && (
                    <p className="text-white/60 text-xs mt-1 font-medium">{PLANS[billing].total}</p>
                  )}
                </div>
